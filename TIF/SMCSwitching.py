# Autor: Lee Dohyeok 
# Contact: dohyeoklee.kr@gmail.com
# Adapdato de: https://github.com/dohyeoklee/Non-linear-control-simulator/tree/main/src
# Se añadieron las lineas 37-44, la función de saturación para el control de modos deslizantes
# Se añadieron las lineas 169-203, para plotear los angulos y sus leyes de control
# Se añadieron las lineas 206-207 y 217-218, para guardar la matriz que contiene las leyes de control
# Se añadió la linea 229-230, para guardar las variables en un archivo data.tex
